  ...
  <main class="flex flex-col h-screen">
    ...
    <spotlight class="flex flex-row justify-center pb-16">
      <template #default="{ img, title, description }">
        <!-- slotProps = {spotlight property: {spotlight object}} -->

        <!-- <template #default="slotProps"> multiple scoped slot -- slotProps = {img: spotlight.img, title="spotlight.title", description="spotlight.description" }} -->
